...
function openScreen(template){
    ...
    if(window.innerWidth<800){
        ...
        if(template==1)url=domain+"/template.html?postItMessage=false&duration=480&autologin=2&title=Eren%20Titan%20Form%20photo%20party&widgets=moderngallery&public=false&noprompt=true&autorun=1&dest=PhotosPage&ihm=perso&activities=photo&flyer=https://fthmb.tqn.com/wKkkWbIJxFrKrJ75cxSk2UgiRdw=/2119x1415/filters:fill(auto,1)/iStock-618066222-59a42d02685fbe00102b159a.jpg";
