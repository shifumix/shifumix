...
function openScreen(template){
    ...
    if(window.innerWidth<800){
        ...
        if(template==9)url=domain+"/template.html?postitMessage=false&duration=480&autologin=2&title=My%20meeting&widgets=presentation&public=false&noprompt=true&autorun=1&dest=ChartsPage&ihm=perso&activities=presentation,message,survey&flyer=https://cdn.forbes.com.mx/2015/04/Internet-negocios-siluetas.jpg";
