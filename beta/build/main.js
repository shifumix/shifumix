...
var Maintools_1 = __webpack_require__(2);
var api_1 = __webpack_require__(16);
var invite_1 = __webpack_require__(47);
var core_2 = __webpack_require__(7);
var settings_1 = __webpack_require__(21);
/**
...
var Maintools_1 = __webpack_require__(2);
var event_data_1 = __webpack_require__(15);
var angular2_qrscanner_1 = __webpack_require__(321);
/**
...
var ScreensPage = /** @class */ (function () {
    ...
    ScreensPage.prototype.ionViewDidLoad = function () {
        ...
        if (this.navParams.get("code") != null) {
            this.searchScreen(this.navParams.get("code"), this.navParams.get("widget"), function () {
                setTimeout(function () {
...
var ProfilPage = /** @class */ (function () {
    ...
    ProfilPage.prototype.updateEvent = function () {
        ...
        this.eventData.updateevent("title,icon,password,autologin,allowAnonymous,visibleOnMap,startJetons,welcomePicture,welcomeDuration,selfservice,loc_query,hTag,needValidate,minCreditToJoin,minDistance,minScoreToJoin,maxOnline,linkToOwner,laCarte,selfservice").subscribe(function (rep) {
            if (rep != null) {
                _this.userData.user = rep;
            }
        });
    ...
    ProfilPage.prototype.closeEvent = function () {
        var _this = this;
        Maintools_1.showConfirm("LIB.EVENTCLOSING", this.alertCtrl, this.translate, function () {
            _this.eventData.closeevent(_this.userData.user.id).subscribe(function (resp) {
                _this.userData.user = resp;
                var delay = Number(resp.message) - new Date().getTime();
                // if(delay<10000)
                //   this.events.publish("event:logout");
                // else {
                Maintools_1.toast(_this.toastCtrl, "End in " + Maintools_1.getDelay(Number(_this.userData.user.message)));
                // }
            });
        });
    };
    ProfilPage.prototype.selIcon = function () {
        var _this = this;
        Maintools_1.openModal(this.modalCtrl, image_creator_1.ImageCreatorPage, { ratio: 1, upload: false }, function (rep) {
            if (rep != null) {
...
var Maintools_1 = __webpack_require__(2);
var Maintools_2 = __webpack_require__(2);
var addpresentation_1 = __webpack_require__(323);
var settings_1 = __webpack_require__(21);
var remote_1 = __webpack_require__(324);
            ...
            if (this.currentCategory == "pro") {
                this.api.getAvatarsPro(36, this.pseudo).subscribe(function (rep) {
                    ...
                    items.forEach(function (s) {
                        var url = _this.sanitizer.bypassSecurityTrustResourceUrl(s);
                        _this.avatars.push(["pro", "", url]);
                    });
                    _this.index = 0;
...
exports.CONFIG = __webpack_require__(315);
...
function getLibs() {
    ...
    libs.push({
        ...
        'labels': {
            ...
            'LIB.CLEAR': "Clear",
            'LIB.UPDATE': "update",
            'LIB.MODERATOR': "Add a new moderator",
            ...
            'ADDEVENT.PASSWORD': "Password to enter in the event",
            ...
            'WIDGET.OPENONTHISSCREEN': "Open the iWall on this device",
            ...
            'ADDEVENT.DEFAULTWIDGET': "Default widget",
            'ADDEVENT.DEFAULTWIDGETSET': "Default widget set",
            ...
            'CHARTS.GIVESCOIN': "Distribute iCoins for :",
    ...
    libs.push({
        ...
        'labels': {
            ...
            'WIDGET.OPENONTHISSCREEN': "Ouvrir l'iWall sur cet appareil",
            ...
            'ADDEVENT.DEFAULTWIDGET': "Widget par défaut",
            'ADDEVENT.DEFAULTWIDGETSET': "Widget par défaut modifié",
            ...
            'CHARTS.GIVESCOIN': "Distribuer des iCoins pour :",
            ...
            'ADDEVENT.PASSWORD': "Mot de passe pour entrer",
            ...
            'SELEVENT.TITLE': "Trouver un événement",
            ...
            'LIB.MODELS': "modeles",
            'LIB.MODERATOR': "Ajouter un modérateur",
...
var user_data_1 = __webpack_require__(8);
var Tools = __webpack_require__(2);
var search_1 = __webpack_require__(329);
var platform_browser_1 = __webpack_require__(22);
var public_profil_1 = __webpack_require__(54);
var Maintools_1 = __webpack_require__(2);
var Maintools_2 = __webpack_require__(2);
...
var core_2 = __webpack_require__(7);
var settings_1 = __webpack_require__(21);
var musiccharts_1 = __webpack_require__(330);
/**
...
var addbets_1 = __webpack_require__(189);
var invite_1 = __webpack_require__(47);
var addloterie_1 = __webpack_require__(333);
var event_data_1 = __webpack_require__(15);
var user_data_1 = __webpack_require__(8);
var platform_browser_1 = __webpack_require__(22);
var core_2 = __webpack_require__(7);
...
var Tools = __webpack_require__(2);
var core_2 = __webpack_require__(7);
var preparecommand_1 = __webpack_require__(335);
var Maintools_1 = __webpack_require__(2);
var storage_1 = __webpack_require__(42);
var ng_push_1 = __webpack_require__(85);
/**
...
var MessagesPage = /** @class */ (function () {
    ...
    function MessagesPage(events, navCtrl, navParams, toastCtrl, translate, alertCtrl, eventData, userData, actionSheetCtrl) {
        this.events = events;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.toastCtrl = toastCtrl;
    ...
    MessagesPage.prototype.updateEvent = function () {
        this.eventData.updateevent("link_label,postItMessage,messageLimitByUser").subscribe(function () { });
    };
...
var public_profil_1 = __webpack_require__(54);
var core_2 = __webpack_require__(7);
var wholikeme_1 = __webpack_require__(338);
var api_1 = __webpack_require__(16);
/**
...
var app_module_1 = __webpack_require__(477);
...
var camera_1 = __webpack_require__(229);
var geolocation_1 = __webpack_require__(231);
var file_1 = __webpack_require__(485);
var ionic_angular_1 = __webpack_require__(3);
var storage_1 = __webpack_require__(42);
var app_component_1 = __webpack_require__(529);
var about_1 = __webpack_require__(340);
var about_popover_1 = __webpack_require__(545);
var perso_1 = __webpack_require__(84);
var login_1 = __webpack_require__(181);
var selevent_1 = __webpack_require__(182);
var addevent_1 = __webpack_require__(82);
var tabs_page_1 = __webpack_require__(325);
var tutorial_1 = __webpack_require__(326);
var support_1 = __webpack_require__(327);
var screens_1 = __webpack_require__(185);
var public_profil_1 = __webpack_require__(54);
var tarifs_1 = __webpack_require__(322);
var widget_1 = __webpack_require__(183);
var widgetstore_1 = __webpack_require__(83);
var search_1 = __webpack_require__(329);
var photos_1 = __webpack_require__(331);
var musicserver_1 = __webpack_require__(107);
var invite_1 = __webpack_require__(47);
var htmleditor_1 = __webpack_require__(184);
var closedevent_1 = __webpack_require__(108);
var addbets_1 = __webpack_require__(189);
var addloterie_1 = __webpack_require__(333);
var bets_1 = __webpack_require__(332);
var board_1 = __webpack_require__(546);
var charts_1 = __webpack_require__(337);
var home_1 = __webpack_require__(328);
var user_data_1 = __webpack_require__(8);
var core_2 = __webpack_require__(7);
var event_data_1 = __webpack_require__(15);
var profil_1 = __webpack_require__(187);
var order_by_1 = __webpack_require__(547);
var filter_1 = __webpack_require__(548);
var loginemail_1 = __webpack_require__(186);
var addevent_date_1 = __webpack_require__(319);
var addevent_advanced_1 = __webpack_require__(318);
var addevent_flyer_1 = __webpack_require__(320);
var customercommand_1 = __webpack_require__(334);
var preparecommand_1 = __webpack_require__(335);
var addevent_modele_1 = __webpack_require__(317);
var ngx_clipboard_1 = __webpack_require__(549);
var focusme_1 = __webpack_require__(551);
var shifubutton_1 = __webpack_require__(552);
var shifuinput_1 = __webpack_require__(553);
var shifurange_1 = __webpack_require__(554);
var tuto_1 = __webpack_require__(560);
var shifuimagefile_1 = __webpack_require__(561);
var shifugroup_1 = __webpack_require__(562);
var shifutitle_1 = __webpack_require__(563);
var shifuwait_1 = __webpack_require__(564);
var shifucheckbox_1 = __webpack_require__(565);
var shifucamera_1 = __webpack_require__(566);
var svgedit_1 = __webpack_require__(567);
var safe_1 = __webpack_require__(568);
var shifucard_1 = __webpack_require__(569);
var messages_1 = __webpack_require__(336);
var api_1 = __webpack_require__(16);
var shifuflyer_1 = __webpack_require__(570);
var shifuevent_1 = __webpack_require__(571);
var shifuprofil_1 = __webpack_require__(572);
var shifutimer_1 = __webpack_require__(573);
var shifuimageprofil_1 = __webpack_require__(574);
var oldevents_1 = __webpack_require__(339);
var image_creator_1 = __webpack_require__(38);
var angular2_qrscanner_1 = __webpack_require__(321);
var ng2_ace_editor_1 = __webpack_require__(575);
var shifunote_1 = __webpack_require__(581);
var app_version_1 = __webpack_require__(582);
var shifubet_1 = __webpack_require__(583);
var wholikeme_1 = __webpack_require__(338);
var network_1 = __webpack_require__(341);
var welcome_1 = __webpack_require__(342);
var term_of_use_1 = __webpack_require__(343);
var shifubuttongroup_1 = __webpack_require__(584);
var loginavatar_1 = __webpack_require__(190);
var settings_1 = __webpack_require__(21);
var ng_push_1 = __webpack_require__(85);
var musiccharts_1 = __webpack_require__(330);
var presentations_1 = __webpack_require__(188);
var shifufile_1 = __webpack_require__(585);
var addpresentation_1 = __webpack_require__(323);
var shifudate_1 = __webpack_require__(586);
var remote_1 = __webpack_require__(324);
var shifugallery_1 = __webpack_require__(587);
var ng_recaptcha_1 = __webpack_require__(588);
var shifunumpad_1 = __webpack_require__(593);
var http_1 = __webpack_require__(106);
//import { EmojiModule } from '@ctrl/ngx-emoji-mart/ngx-emoji'
//import { PickerModule } from '@ctrl/ngx-emoji-mart'
var ng_emoji_picker_1 = __webpack_require__(594);
        ...
        this.userData.join(params.event.id, params.password, "", "", this.userData.user.lat + "," + this.userData.user.lng, "", this.userData.user.currentView)
            ...
            if (rep != null) {
                ...
                if (rep.message.length == 0) { //Pas de message d'alerte
                    ...
                    _this.eventData.join(params.event.id, _this.userData.user.id, label, function (rep) {
...
var noop_1 = __webpack_require__(344);
var core_2 = __webpack_require__(7);
var Maintools_1 = __webpack_require__(2);
...
var PersoPage = /** @class */ (function () {
    ...
    PersoPage.prototype.updateUser = function () {
        ...
        this.userData.senduser("home,picture,userSettingsFile,musicServer,profil,tags,firstname,publicPatterns,picture,defaultAddress,humeur").subscribe(function (rep) { });
    };
