...
var ClosedeventPage = /** @class */ (function () {
    ...
    ClosedeventPage.prototype.ionViewWillEnter = function () {
        ...
        this.api.getpresents(this.event.id, true).subscribe(function (resp) {
            ...
            if (vm.event.activities.indexOf("bets") > -1) {
...
var ProfilPage = /** @class */ (function () {
    ...
    ProfilPage.prototype.updateEvent = function () {
        ...
        this.eventData.updateevent("title,password,autologin,allowAnonymous,visibleOnMap,startJetons,welcomePicture,welcomeDuration,selfservice,loc_query,hTag,needValidate,minCreditToJoin,minDistance,minScoreToJoin,maxOnline,linkToOwner,laCarte,selfservice").subscribe(function (rep) {
            if (rep != null) {
                _this.userData.user = rep;
            }
        });
    ...
    */
    ...
    temp.forEach(function (it) {
        ...
        if (it.minLevel == undefined)
            it.minLevel = 0;
        it.text = it.name;
        if (it.version >= version && level >= it.minLevel && (getEnv() == 0 || it.name.indexOf("local") == -1))
            rc.push(it);
    });
    var rc2 = [];
    if (filter == undefined)
    ...
    ShifubuttongroupComponent.prototype.refresh = function () {
        ...
        for (var i = 0; i < size; i++) {
            ...
            if (this.descriptions != null)
                bt.description = this.translate.instant(this.descriptions.split(",")[i]);
            if (this.labels != null)
...
var AddeventPage = /** @class */ (function () {
    ...
    __decorate([
        core_1.ViewChild("fab"),
        __metadata("design:type", typeof (_b = typeof ionic_angular_1.FabContainer !== "undefined" && ionic_angular_1.FabContainer) === "function" && _b || Object)
    ...
    AddeventPage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_c = typeof ionic_angular_2.ModalController !== "undefined" && ionic_angular_2.ModalController) === "function" && _c || Object, typeof (_d = typeof core_2.TranslateService !== "undefined" && core_2.TranslateService) === "function" && _d || Object, typeof (_e = typeof ionic_angular_1.ViewController !== "undefined" && ionic_angular_1.ViewController) === "function" && _e || Object, typeof (_f = typeof ionic_angular_2.LoadingController !== "undefined" && ionic_angular_2.LoadingController) === "function" && _f || Object, typeof (_g = typeof ionic_angular_1.NavParams !== "undefined" && ionic_angular_1.NavParams) === "function" && _g || Object, typeof (_h = typeof event_data_1.EventDataProvider !== "undefined" && event_data_1.EventDataProvider) === "function" && _h || Object, typeof (_j = typeof ionic_angular_1.ToastController !== "undefined" && ionic_angular_1.ToastController) === "function" && _j || Object, typeof (_k = typeof api_1.ApiProvider !== "undefined" && api_1.ApiProvider) === "function" && _k || Object, typeof (_l = typeof settings_1.SettingsProvider !== "undefined" && settings_1.SettingsProvider) === "function" && _l || Object, typeof (_m = typeof user_data_1.UserData !== "undefined" && user_data_1.UserData) === "function" && _m || Object])
    ], AddeventPage);
    return AddeventPage;
